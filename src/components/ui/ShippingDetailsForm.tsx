  ...
  return (
    <Form form={form} layout="vertical" requiredMark>
      <Row gutter={32}>
        ...
        {/* RIGHT COLUMN: Package Info & Shipping Method */}
        <Col xs={24} md={12}>
          <Typography.Text strong style={{ display: 'block', marginBottom: 12, fontSize: 13 }}>
          ...
          <Row gutter={12}>
            <Col span={shippingMode === 'platform' ? 12 : 24}>
            ...
            <Select
              ...
              onChange={(v) => {
                ...
                if (v === 'platform') {
                  ...
                  form.setFieldsValue({ providerCode: undefined, insuranceValue: 0 })
                }
              }}
          ...
          {shippingMode === 'external' && (
            <>
              ...
              <Form.Item name="externalTrackingNumber" label={t('externalTracking', 'Tracking Number')} rules={[{ required: shippingMode === 'external', message: t('trackingRequired', 'Required') }]}>
