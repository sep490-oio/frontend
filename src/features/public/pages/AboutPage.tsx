  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
      ...
      <section
        ...
        style={{ textAlign: 'center', padding: '120px 0 100px' }}
      >
        <p
          style={{
      ...
      <section
        ...
        style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center', padding: '100px 0' }}
      >
        <div>
        ...
        {/* Stats column */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24, padding: '48px 40px', background: 'var(--color-bg-surface)', borderRadius: 2, position: 'relative' }}>
      ...
      {/* ─── How It Works ─── */}
      <section className="oio-fade-in oio-fade-in-delay-2" style={{ padding: '100px 0', textAlign: 'center' }}>
        <p style={{ fontFamily: SANS_FONT, fontSize: 11, fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--color-accent)', marginBottom: 16 }}>
        ...
        <div className="oio-stagger" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 48 }}>
          {[
            ...
            <div key={step.title} style={{ padding: '40px 32px', textAlign: 'center' }}>
      ...
      {/* ─── Trust & Security ─── */}
      <section className="oio-fade-in oio-fade-in-delay-3" style={{ padding: '100px 0', textAlign: 'center' }}>
        <p style={{ fontFamily: SANS_FONT, fontSize: 11, fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--color-accent)', marginBottom: 16 }}>
        ...
        <div className="oio-stagger" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 32 }}>
          {[
            ...
            <div key={item.title} style={{ padding: '32px 24px', background: 'var(--color-bg-card)', borderRadius: 2, border: '1px solid var(--color-border-light)' }}>
      ...
      {/* ─── CTA ─── */}
      <section className="oio-fade-in" style={{ textAlign: 'center', padding: '80px 0 120px' }}>
